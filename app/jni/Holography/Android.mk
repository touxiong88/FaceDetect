...
LOCAL_SRC_FILES:= \
       ...
       holograhpy/FaceDetector.cpp \
       holograhpy/TimeUtils.cpp \
       holograhpy/HolographyJNI.cpp \
       holograhpy/profile.cpp \
       holograhpy/holography.cpp \
		holograhpy/interLeaveBitmap.cpp 
...
LOCAL_LDLIBS := -L$(SYSROOT)/usr/lib -llog -landroid -lGLESv2


LOCAL_MODULE:= libFFTEmTest
